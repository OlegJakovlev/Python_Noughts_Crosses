...
## Branch description
Master branch has 2 addional gameplay rules:
1. Each player / bot can place either X and O symbols
2. If win combination is found - who placed the last symbol wins

Dev branch has these additional rules removed, making game more classic
